...
void VertexArrayBuffer::bindIndex() const
{
    m_indexBuffer->bind();
}

void VertexArrayBuffer::unbindIndex() const
{
    m_indexBuffer->unbind();
}

std::shared_ptr<IndexBuffer>& VertexArrayBuffer::getIndexBuffer()
{
    return m_indexBuffer;
}

unsigned int VertexArrayBuffer::getID() const
{
    return m_rendererID;
}
